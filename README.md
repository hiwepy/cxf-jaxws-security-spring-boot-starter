...
**cxf-jaxws-security-spring-boot-starter** is a Spring Boot starter that integrates **cxf-rt-javassist** for applications using cxf-rt-javassist. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume cxf-rt-javassist capabilities with minimal setup.
...
| JDK | `17` |
| Coordinates | `io.github.easy4j:cxf-jaxws-security-spring-boot-starter:3.0.x.20260527-SNAPSHOT` |
