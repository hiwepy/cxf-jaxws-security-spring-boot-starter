...
public class JavassistWebserviceGenerator {
	...
	public Class<?> createDynamicClazz() throws Exception {
		...
		// 创建类
		CtClass cc = pool.makeClass("com.coshaho.learn.DynamicHelloWorldImpl");
	...
	public Class<?> createDynamicInterface() throws Exception {
		...
		// 创建类
		CtClass cc = pool.makeInterface("org.apache.cxf.spring.boot.javassist.IDynamicHelloWorld",
				pool.getCtClass("java.lang.Cloneable"));
		// pool.makeInterface("org.apache.cxf.spring.boot.javassist.DynamicHelloWorld");
