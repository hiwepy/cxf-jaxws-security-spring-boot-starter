...
/**
 * 
 * @className	： CtClassProxy
 * @description	： 基于Javassist动态生成字节码实现简单的动态代理 Dynamic Proxy based on Javassist
 * @author 		： <a href="https://github.com/vindell">vindell</a>
 * @date		： 2018年2月25日 下午2:09:51
 * @version 	V1.0
 */
public class CtClassProxy {
	 ...
	 */
	private CtClassProxy() {
	}

	protected CtClassProxy(Interceptor interceptor) {
	 ...
	 */
	public static Object createProxy(Class<?> targetClass, InvocationHandler handler, Class<?>... interfaces2) {
		int index = 0;
		/* 获得运行时类的上下文 */
		...
		try {
			...
			/* 获得 CtClassProxy 类作为代理类的父类 */
			CtClass superclass = pool.get(CtClassProxy.class.getName());
