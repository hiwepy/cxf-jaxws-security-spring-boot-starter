...
public class JaxwsApiCtClassBuilder implements Builder<CtClass> {
	...
	public JaxwsApiCtClassBuilder(final ClassPool pool, final String classname) {
		this.pool = pool;
	...
	public <T> JaxwsApiCtClassBuilder newFieldWithValue(final Class<T> fieldClass, final String fieldName, final String fieldValue) throws CannotCompileException, NotFoundException {
	...
	public <T> JaxwsApiCtClassBuilder newFieldWithAutowired(final Class<T> fieldClass, final String fieldName) throws CannotCompileException, NotFoundException  {
	...
	public <T> JaxwsApiCtClassBuilder proxyMethod(final Class<T> rtClass, final CtWebMethod action, final CtWebResult result, final String methodName, CtWebParam<?>... params) throws CannotCompileException {
