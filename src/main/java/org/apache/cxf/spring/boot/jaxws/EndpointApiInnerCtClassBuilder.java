 ...
 */
public class EndpointApiInnerCtClassBuilder implements Builder<CtClass> {
	...
	public EndpointApiInnerCtClassBuilder(final String classname) throws CannotCompileException, NotFoundException  {
		this(JavassistUtils.getDefaultPool(), classname);
	}
	
	public EndpointApiInnerCtClassBuilder(final ClassPool pool, final String classname) throws CannotCompileException, NotFoundException {
	 ...
	 * @return
	 */
	public EndpointApiInnerCtClassBuilder annotationForType(final String name, final String targetNamespace) {
		return this.annotationForType(targetNamespace, targetNamespace, null, null, null, null);
	}
	
	public EndpointApiInnerCtClassBuilder annotationForType(final String name, final String targetNamespace, String serviceName) {
     ...
     */
	public <T> EndpointApiInnerCtClassBuilder makeField(final String src) throws CannotCompileException {
		//创建属性
        ctclass.addField(CtField.make(src, ctclass));
		return this;
	}
	
	public <T> EndpointApiInnerCtClassBuilder newField(final Class<T> fieldClass, final String fieldName, final String fieldValue) throws CannotCompileException, NotFoundException {
	...
	public <T> EndpointApiInnerCtClassBuilder removeField(final String fieldName) throws NotFoundException {
     ...
     * @param src               the source text. 
     */
	public <T> EndpointApiInnerCtClassBuilder makeMethod(final String src) throws CannotCompileException {
		//创建方法 
	 ...
	 */
	public <T> EndpointApiInnerCtClassBuilder newMethod(final Class<T> rtClass, final String methodName, CtWebParam<?>... params) throws CannotCompileException, NotFoundException {
	 ...
	 * @throws NotFoundException 
	 */
	public <T> EndpointApiInnerCtClassBuilder newMethod(final CtWebResult<T> result, final CtWebMethod method, CtWebParam<?>... params) throws CannotCompileException, NotFoundException {
	...
	public <T> EndpointApiInnerCtClassBuilder removeMethod(final String methodName, CtWebParam<?>... params) throws NotFoundException {
