...
public class MacOAuthDataProvider implements AuthorizationCodeDataProvider {
	...
	public ServerAccessToken createAccessToken(AccessTokenRegistration reg)
        ...
        // generate
		ServerAccessToken token = new MacAccessToken(reg.getClient(), HmacAlgorithm.HmacSHA1,3600L);
